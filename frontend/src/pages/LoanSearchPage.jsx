...
//   // Separate state for Loan Matches and Collaborative Loans
...
//   // Filtering Loan Matches
//   const filteredLoanMatches = loanMatches.filter((loan) => {
//     return (
//       loan.interestRate >= interestRateFilter[0] &&
//       loan.interestRate <= interestRateFilter[1] &&
//       (tenureFilter === "All" || `${loan.loanTerm} months` === tenureFilter)
...
//   const handleRequest = (loan) => {
//     if (selectedLenders.includes(loan._id)) {
//       setSelectedLenders(selectedLenders.filter((id) => id !== loan._id));
//     } else {
//       setSelectedLenders([...selectedLenders, loan._id]);
//     }
//   };

//   return (
//     <div className="p-6 max-w-5xl mx-auto">
//       <h2 className="text-3xl font-bold mb-6">Loan Matching Platform</h2>
//       <Tabs>
...
//           <h3 className="text-2xl font-semibold mb-4">Loan Matches</h3>
//           <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
//             {filteredLoanMatches.length > 0 ? (
//               filteredLoanMatches.map((loan) => (
//                 <div key={loan._id} className="p-4 bg-gray-50 border rounded-lg shadow-sm">
//                   <h4 className="text-lg font-semibold">Loan ID: {loan._id}</h4>
//                   <p className="text-sm text-gray-600">Amount: ₹{loan.amountRequested}</p>
//                   <p className="text-sm text-gray-600">Interest Rate: {loan.interestRate}%</p>
...
//               ))
//             ) : (
//               <p className="text-gray-500">No matching loans available.</p>
//             )}
//           </div>
//         </TabPanel>

//         {/* Collaborative Loans Tab */}
//         <TabPanel>
//           <h3 className="text-2xl font-semibold mb-4">Collaborative Loans</h3>
//           <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
//             {filteredCollaborativeLoans.length > 0 ? (
//               filteredCollaborativeLoans.map((loan) => (
//                 <div key={loan._id} className="p-4 bg-gray-50 border rounded-lg shadow-sm">
//                   <h4 className="text-lg font-semibold">Loan ID: {loan._id}</h4>
//                   <p className="text-sm text-gray-600">Amount: ₹{loan.amountRequested}</p>
...
//               ))
//             ) : (
//               <p className="text-gray-500">No collaborative loans available.</p>
//             )}
//           </div>
//         </TabPanel>
//       </Tabs>
...
//       toast.info("❌ Loan request canceled.");
