...
const RepaymentTracking = () => {
  const [repayments, setRepayments] = useState([
    { id: 1, dueDate: "2025-04-08", amount: 200000, status: "Prospective" },
    { id: 2, dueDate: "2025-04-06", amount: 10000, status: "Prospective" },
    { id: 3, dueDate: "2025-04-04", amount: 5000, status: "Upcoming" },
  ]);
